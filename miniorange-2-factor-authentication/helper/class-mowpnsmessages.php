...
if ( ! class_exists( 'MoWpnsMessages' ) ) {
	...
	class MoWpnsMessages {
		...
		const LOW_SMS_TRANSACTIONS   = "<div class='mo2f-custom-notice notice notice-warning low_sms-notice MOWrn'><div class='flex gap-mo-3 w-full'><p class='notice-message'><img src='" . MO2F_PLUGIN_URL . '/includes/images/miniorange_icon.png' . "'>&nbsp;&nbsp;You have left very few SMS transaction. We advise you to recharge or change 2FA method before you have no SMS left.</p><a class='notice-button' href='" . MoWpnsConstants::RECHARGELINK . "' target='_blank' >RECHARGE</a><a class='notice-button' href='admin.php?page=mo_2fa_my_account&subpage=setupyour2fa' id='setuptwofa_redirect' >SET UP ANOTHER 2FA</a><button class='sms_low_dismiss notice-button' ><i>DISMISS</i></button><button class='sms_low_dismiss_always notice-button'><i>NEVER SHOW AGAIN</i></button></div></div>";
		const LOW_EMAIL_TRANSACTIONS = "<div class='mo2f-custom-notice notice notice-warning low_email-notice MOWrn'><div class='flex gap-mo-3 w-full'><p class='notice-message'><img src='" . MO2F_PLUGIN_URL . '/includes/images/miniorange_icon.png' . "'>&nbsp;&nbsp;You have left very few Email transaction. We advise you to recharge or change 2FA method before you have no Email left.</p><a class='notice-button' href='" . MoWpnsConstants::RECHARGELINK . "' target='_blank' >RECHARGE</a><a class='notice-button' href='admin.php?page=mo_2fa_my_account&subpage=setupyour2fa' id='setuptwofa_redirect' >SET UP ANOTHER 2FA</a><button class='email_low_dismiss notice-button' ><i>DISMISS</i></button><button class='email_low_dismiss_always notice-button'><i>NEVER SHOW AGAIN</i></button></div></div>";
		...
		const BACKUP_CODES_SENT_SUCCESS                  = 'An email containing the backup codes has been sent. Please click on <strong>Use Backup Codes</strong> to login using the backup codes.';
